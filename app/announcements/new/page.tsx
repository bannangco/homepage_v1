  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="title" className="mb-2 block text-gray-200">
            제목
          </label>
          <input
            type="text"
            ...
            className="w-full rounded-lg bg-gray-800/40 px-4 py-2 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            required
          />
        </div>

        <div>
          <label htmlFor="content" className="mb-2 block text-gray-200">
            내용
          </label>
          <textarea
            id="content"
        ...
        <div>
          <label htmlFor="file" className="mb-2 block text-gray-200">
            첨부파일
          </label>
          <input
            type="file"
